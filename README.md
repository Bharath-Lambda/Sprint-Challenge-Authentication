...
Sessions are a way to persist information, such as authentication credentials, from a user across requests.

1. What does bcrypt do to help us store passwords in a secure manner.

It applies a hashing function to encrypt a user's password, protecting it from attacks.

1. What does bcrypt do to slow down attackers?

Bcrypt uses an algortihm that hashes information in multiple rounds.
